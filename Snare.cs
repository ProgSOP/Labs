...
{
    internal class Snare:Drums
    {
        public string _tune { get; set; }
        public Snare(string name, string lenth, string width, string sound, string tune) :
