...
{
    internal class JoicePro:JoiceStart
    {
        public string _bonuses { get; set; }

        public JoicePro (int id, string name, int price, string amoundOfInternet, int NumberOfMinutes, int NumberOfRouming, string bonuses):
            base (id,name,price,amoundOfInternet,NumberOfMinutes,NumberOfRouming)
        {
            _bonuses = bonuses;
        }
        public void Writer()
